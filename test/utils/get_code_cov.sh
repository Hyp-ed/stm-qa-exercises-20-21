...
lcov -q -i --directory  bin -b . --capture --no-external --output-file ./test/coverage/covdata/hyped.base.covdata
...
lcov -q --directory bin -b . --capture --no-external --output-file ./test/coverage/covdata/hyped.test.covdata
